...
Module InputUtils
    ...
    Public Sub MouseLeftClick(clickPoint As Drawing.Point, Optional shift As Boolean = False, Optional control As Boolean = False)
        If shift Then
            KeyDown(Keys.Shift)
        End If
    ...
    Public Sub MouseRightClick(clickPoint As Drawing.Point, Optional shift As Boolean = False, Optional control As Boolean = False)
        If shift Then
            KeyDown(Keys.Shift)
        End If
    ...
    Public Sub MouseDoubleClick(clickPoint As Drawing.Point, Optional shift As Boolean = False, Optional control As Boolean = False)
        If shift Then
            KeyDown(Keys.Shift)
        End If
