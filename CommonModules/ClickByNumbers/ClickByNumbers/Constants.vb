Module Constants
    ...
    Public Const REGISTRY_PATH As String = "Software\Douglas Parent\Click By Numbers"
    Public Const REGISTRY_PATH_APP_SETTINGS As String = REGISTRY_PATH & "\AppSettings"
    Public Const REGISTRY_PATH_GLOBAL_SETTINGS As String = REGISTRY_PATH & "\GlobalSettings"
    ...
    Public Const REGISTRY_VALUE_BRING_TO_FOREGROUND_HOTKEY As String = "BringToForegroundHotkey"

    Public Const DEFAULT_PROCESS_NAME As String = "<default>"
